...
public class OurServer {
    ...
    // if the database whines, right click resources in intellij, scroll down to "Mark Folder As" and choose resources
    // then in application.properties set the appropriate values
